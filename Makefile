...
#    Updated: 2018/07/23 19:53:23 by alanter          ###   ########.fr        #
#                                                                              #
# **************************************************************************** #
...
ifeq ($(OS),Darwin)
	...
	#FLAGS_DEFAULT = -g3 -O1 -g -fsanitize=address -fno-omit-frame-pointer  -fsanitize-address-use-after-scope #-pedantic -Wall -Werror -Wextra -g3 -fsanitize=address
